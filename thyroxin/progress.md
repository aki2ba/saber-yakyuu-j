...
- **評判ラベル（メディア評）**: awards.mjs 拡張。勝負師/劇場型（観測 Clutch・WPA・RISP）、
  ブレーキ、ガラスの体、鉄人 等を**観測集計のみ**から導出（真値に「勝負強さ」は存在しない＝
  三層構造の思想通り「ファンとメディアが作る物語と真値のズレ」がコンテンツになる）。
  閾値は `tuning.awards.reputation`
